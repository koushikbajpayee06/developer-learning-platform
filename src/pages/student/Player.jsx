...
const Player = () => {
  ...
  return (
    <>
      <div className="p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-2 md:px-36">
        {/* left column */}
            ...
            playerData ? (
              <div>
                ...
                <div className="flex justify-between items-center mt-1">
                  ...
                  <button className="text-blue-600">{false ? "Compleated" :"Mark Complete"}</button>
                </div>
              </div>
            ) :
